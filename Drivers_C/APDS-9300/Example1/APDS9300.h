...
/**
 * @file /APDS-9300/Example1/APDS9300.h
 * @author D.Qendri
 * @date 28 May 2015
 * @brief APDS9300 driver header file.    
 */
...
typedef enum{
            S1 = INTEG13_7MS,		/*!< Sampling time of 13.7ms .*/
			S2 = INTEG101MS,		/*!< Sampling time of 101 ms .*/
			S3 = INTEG402MS			/*!< Sampling time of 402 ms .*/
			}sampTime_t;
