...
module.exports = function(RED) {
    ...
    function SensorianMagnetometerSensorNode(n) {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('magnetometer' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['magnetometer']");
                            console.log(dictionary_info['magnetometer']);
                            console.log("END dictionary_info['magnetometer']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.magnetometer.toString()};
    ...
    RED.nodes.registerType("sensorian-magnetometer",SensorianMagnetometerSensorNode);
}
