...
module.exports = function(RED) {
    ...
    function SensorianAccelerometerSensorNode(n) {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('accelerometer' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['accelerometer']");
                            console.log(dictionary_info['accelerometer']);
                            console.log("END dictionary_info['accelerometer']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.accelerometer.toString()};
    ...
    RED.nodes.registerType("sensorian-accelerometer",SensorianAccelerometerSensorNode);
}
