...
module.exports = function(RED) {
    ...
    function SensorianTemperatureSensorNode(n) {
        ...
        this.on('input',function(msg) {
                console.log("Temperature read was triggered.");
                exec('SensorianReadTemperature.py', function(error, stdout, stderr) {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('temperature' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['temperature']");
                            console.log(dictionary_info['temperature']);
                            console.log("END dictionary_info['temperature']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.temperature.toString()};
    ...
    RED.nodes.registerType("sensorian-temperature",SensorianTemperatureSensorNode);
}
