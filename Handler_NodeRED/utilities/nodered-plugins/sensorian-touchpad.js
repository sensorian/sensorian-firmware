...
module.exports = function(RED) {
    ...
    function SensorianTouchpadSensorNode(n) {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('touchpad' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['touchpad']");
                            console.log(dictionary_info['touchpad']);
                            console.log("END dictionary_info['touchpad']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.touchpad.toString()};
    ...
    RED.nodes.registerType("sensorian-touchpad",SensorianTouchpadSensorNode);
}
