...
module.exports = function(RED) {
    ...
    function SensorianAmbientLightSensorNode(n) {
        ...
        this.on('input',function(msg) {
                console.log("Ambient light read was triggered.");
                exec('SensorianReadAmbientLight.py', function(error, stdout, stderr) {
                    console.log("Reading Ambient Light");
                    console.log(stdout);
                    if (error != null)
                    {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('ambientlight' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['ambientlight']");
                            console.log(dictionary_info['ambientlight']);
                            console.log("END dictionary_info['ambientlight']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.ambientlight.toString()};
    ...
    RED.nodes.registerType("sensorian-ambientlight",SensorianAmbientLightSensorNode);
}
