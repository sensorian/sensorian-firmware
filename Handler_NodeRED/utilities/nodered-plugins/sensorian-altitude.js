...
module.exports = function(RED) {
    ...
    function SensorianAltitudeSensorNode(n) {
        ...
        this.on('input',function(msg) {
                console.log("Altitude read was triggered.");
                exec('SensorianReadAltitude.py', function(error, stdout, stderr) {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('altitude' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['altitude']");
                            console.log(dictionary_info['altitude']);
                            console.log("END dictionary_info['altitude']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.altitude.toString()};
    ...
    RED.nodes.registerType("sensorian-altitude",SensorianAltitudeSensorNode);
}
