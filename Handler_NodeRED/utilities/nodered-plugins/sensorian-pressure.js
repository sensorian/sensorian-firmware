...
module.exports = function(RED) {
    ...
    function SensorianPressureSensorNode(n) {
        ...
        this.on('input',function(msg) {
                console.log("Pressure read was triggered.");
                exec('SensorianReadPressure.py', function(error, stdout, stderr) {
            ...
            client = net.connect(node.port, node.host, function() {
                ...
                client.on('data', function (data) {
                    ...
                    if (node.stream)
                    {
                        ...
                        if ('pressure' in dictionary_info)
                        {
                            console.log("BEGIN dictionary_info['pressure']");
                            console.log(dictionary_info['pressure']);
                            console.log("END dictionary_info['pressure']");
                            //var msg = {topic:node.topic, payload:data};
                            var msg = {topic:node.topic, payload:dictionary_info.pressure.toString()};
    ...
    RED.nodes.registerType("sensorian-pressure",SensorianPressureSensorNode);
}
