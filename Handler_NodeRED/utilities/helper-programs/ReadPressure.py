...
mmap_pressure_file = open('/home/pi/.sensorian/mmap_pressure','a+b')
mmap_pressure = mmap.mmap(mmap_pressure_file.fileno(),0,access=mmap.ACCESS_WRITE)

#Check if multithreaded_socket_server.py is busy sending data
if mmap_pressure[1] == '1':
	sys.exit()
